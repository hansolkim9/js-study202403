...
function verifyAnswer($target) {
    ...
    if (secret === answer) { // 정답인 경우
        ...
        const isUp = secret > answer; // up일때 true, down일때 false
        ...
        // 정담 범위 밖의 구슬들을 제거하고 새롭게 구슬을 렌더링
...
function iconClickHandler(e) {
    if (!e.target.matches('#numbers .icon')) return; // 구슬 외 배경 제외
