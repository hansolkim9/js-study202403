...
const userNames = ['김철수', '김영수', '박영식'];

// userNames에서 각각의 요소들을 다시 변수에 집어넣고 싶다.
// const chul = userNames[0];
// const young = userNames[1];
// const sik = userNames[2];

const [chul, young, sik] = userNames; // 위 3줄을 한줄로 만들어 버림!

console.log((`a: ${chul}, b: ${young}, c: ${sik}`));
