...
//                   하나의 결과값을 반환하는 함수
// reducedp emfdjrksms callback
// callback(accumulator, currentValue) 
// accumulator: 어떤 데이터를 계속 쌓아가는 변소
// currentValue: 현재 루프회차에서 사용할 데이터
// reduce는 반복을 실행할때마다 currentValue를 accmulator에 누적함.

// 사과바구니에 있는 사과들의 모든 당도를 합산한 결과 얻기
// const result = [1, 2, 3, 4, 5, 6].reduce((prev, current, idx) => {
//     console.log(prev);
//     console.log(current);
//     console.log(idx);
    // console.log(arr);
...
// console.log('===============');
// 사과바구니에 있는 사람들의 모든 당도를 합산한 결과 얻기
const resultTotalSweet = appleBasket.reduce((totalSweet, apple, idx) => {
